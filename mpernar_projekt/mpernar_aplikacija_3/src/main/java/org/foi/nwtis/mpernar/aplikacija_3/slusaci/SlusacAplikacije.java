package org.foi.nwtis.mpernar.aplikacija_3.slusaci;
...
public class SlusacAplikacije implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {    
            ...
            int port = Integer.parseInt(konfBP.dajPostavku("server.podataka.port"));
            String adresa = konfBP.dajPostavku("server.podataka.adresa");
